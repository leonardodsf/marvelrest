...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">   
      ...
      $sql = "DELETE FROM marvelusuario WHERE idusuario = $idusuario";
      if ($conn->query($sql) === TRUE) {
          echo "<div class='alert alert-success col-12'
          role='alert'>Usuario excluído com sucesso!</div>";
      } else {
      ...
      $conn->close();
      ?>
      <a class="btn btn-success" href="./users.php" role="button">Voltar</a>
    </div>
  </div>
